...
public class MainActivity extends Activity {
    ...
    public class ApiUbidots extends AsyncTask<Integer, ProgressUpdate, Void> {
        private final String API_KEY_UBIDOTS = "BBFF-bJQFmRdN8NkRQwCRoUwu34g2ek6JeW";
        private final String TempVariable_ID = "6227fc251d84727a1b25f61c";
        private final String HumVariable_ID = "624cd8321d84725f3fbeeac4";
