...
//Conexión a Internet
const char* ssid = "IoT"; //Nombre de su internet
const char* password = "1t3s0IoT18"; //Contraseña de su internet
//Información para poder subir datos a ThingSpeak

unsigned long channelID = 1676560; //ID del canal de UDS
const char* WriteAPIKey = "VF4KPRG5AQTR8EHH"; //Write API Key del canal que creaste
